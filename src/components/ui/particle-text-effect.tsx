...
export function ParticleTextEffect({ words = DEFAULT_WORDS, height = 500, fitParent = false, backgroundFade = "rgba(0, 0, 0, 0.1)", className = "" }: ParticleTextEffectProps) {
  ...
  useEffect(() => {
    ...
    const setCanvasSize = () => {
      if (fitParent && wrapperRef.current) {
